...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'starekreskowki@6m8wql.onmicrosoft.com',
  ...
  footer:
    'Wskazane jest używanie Przeglądarki Microsoft Edge',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/KubaczyliJacob12',
    },
  ],
